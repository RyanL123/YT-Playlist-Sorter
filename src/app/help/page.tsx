...
const Help = () => (
  <Box py="5vh" px="10vw">
    ...
    <Typography component="p" color="text.secondary" mb={5}>
      ...
      <b>PLFs4vir_WsTwEd-nJgVJCZPNL3HALHHpF</b>, and the playlist ID would be
      the bolded part, <b>PLFs4vir_WsTwEd-nJgVJCZPNL3HALHHpF</b>. You can also
      paste in the entire link. In fact, try sorting it using the sorter!
    </Typography>
    <Typography
      variant="h5"
      component="h5"
    ...
    <Typography component="p" color="text.secondary" mb={5}>
      ...
      maximum of 200 videos will be sorted due to API limits.
    </Typography>
    <Typography
      variant="h5"
      component="h5"
